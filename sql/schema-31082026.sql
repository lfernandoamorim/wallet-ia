-- =============================================================================
-- Script de Criação e Configuração do Banco de Dados: walletia
-- Data de Criação: 31/08/2026
-- Arquivo: sql/schema-31082026.sql
-- Descrição: Estrutura completa de tabelas, índices, extensão pgvector (RAG),
--            sistema de controle de acesso baseado em roles (RBAC) e dados iniciais (Seed).
-- =============================================================================

-- Caso deseje criar o banco do zero via psql, descomente a linha abaixo:
-- CREATE DATABASE walletia WITH OWNER = postgres ENCODING = 'UTF8';
-- \c walletia;
...
-- -----------------------------------------------------------------------------
-- 3. TABELAS DE ROLES E PERMISSÕES (RBAC)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. TABELA DE CREDENCIAIS DE PROVEDORES DE IA
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. TABELAS DE BASES DE CONHECIMENTO E DOCUMENTOS (RAG)
-- -----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS kb_chunks (
    ...
    embedding           VECTOR(1536),                          -- Vetor semântico para similaridade de cosseno
    metadata            JSONB,
...
-- -----------------------------------------------------------------------------
-- 6. TABELAS DE AGENTES E PERSONAS
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS agents (
    ...
    name            VARCHAR(255) NOT NULL,
    description     TEXT,
    system_prompt   TEXT NOT NULL,                            -- Persona e instruções do agente
    provider        VARCHAR(50) NOT NULL,                     -- 'openrouter' | 'openai' | 'anthropic' | 'gemini'
    model           VARCHAR(100) NOT NULL,                    -- ex: 'gpt-4o', 'claude-3-5-sonnet', 'gemini-1.5-pro'
...
-- -----------------------------------------------------------------------------
-- 7. TABELAS DE CONVERSAS, MENSAGENS E ANEXOS (CHAT)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 8. TABELA DE COMPARTILHAMENTO DE RECURSOS (POLIMÓRFICA)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 9. DADOS INICIAIS (SEED DE PERMISSÕES E ROLES DO SISTEMA)
-- -----------------------------------------------------------------------------
